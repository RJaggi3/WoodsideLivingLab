...
for channel_group in chunks(channels, 6):
    ...
    for i, channel in enumerate(channel_group):
        ...
        # ---------------------------------------------------
        # DECIMATION (for Frequency Domain & Reconstruction)
        # ---------------------------------------------------
        ...
        # ------------------------------------------------------------
        # RECONSTRUCT DECIMATED DATA VIA IFFT (Time Domain with Zero Padding)
        # ------------------------------------------------------------
        ...
        # Set the same y-axis limits for both the original and reconstructed data.
