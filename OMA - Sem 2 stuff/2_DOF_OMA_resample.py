...
fig_ref, Results_ref = PyOMA.SSIdatStaDiag(accel, fs, br=50)
plt.close(fig_ref)
Results_mod_ref      = PyOMA.SSIModEX([fn1, fn2], Results_ref)
...
for method in methods:
    for q in q_factors:
        ...
        fig_q, Results_q = PyOMA.SSIdatStaDiag(accel_q, fs_q, br=50)
        plt.close(fig_q)
        Results_mod_q    = PyOMA.SSIModEX([fn1, fn2], Results_q)
...
plt.title("Mode 1 Frequency vs Compression")
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.savefig("mode1_freq_vs_q.png", dpi=300)
plt.show()
...
plt.title("Mode 2 Frequency vs Compression")
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.savefig("mode2_freq_vs_q.png", dpi=300)
plt.show()
...
plt.title("Extracted Damping vs Compression")
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.savefig("damping_vs_q.png", dpi=300)
plt.show()